...
class AskRecipeScreen extends StatefulHookConsumerWidget {

  AskRecipeScreen();

  @override
  AskRecipeScreenState createState() => new AskRecipeScreenState();
}

class AskRecipeScreenState extends ConsumerState<AskRecipeScreen> {
  ...
  Future<void> ia_generotor() async {
    ...
    if(itemsController.text.isEmpty ) {
       ...
       Fluttertoast.showToast(
        ...
        String request = promptRequest.replaceAll("@param_ingredient",itemsController.text.toString());
  ...
  void initModel() async {
    ...
    model = GenerativeModel(model: 'gemini-1.5-pro', apiKey: Setting.apikey, systemInstruction: Content.text(AppLocalizations.of(context)!.txt_prompt_content2), generationConfig: GenerationConfig(temperature: 0.0, responseMimeType: "application/json"  ) );
    setState(() {
      promptRequest = AppLocalizations.of(context)!.txt_prompt2;
    });
  }
  ...
  Widget build(BuildContext context) {
      ...
      backgroundColor: Setting.white,
             appBar: AppBar(
              title: Text(AppLocalizations.of(context)!.txt_bloc2,  style: TextStyle(color: Colors.white,  fontFamily: 'Candara', fontWeight: FontWeight.bold, fontSize: 18.0), ),
        ...
        child: Container(
              ...
              child: Column(
                ...
                children: [
                    ...
                    Text(AppLocalizations.of(context)!.txt_bloc21, style: TextStyle(  fontWeight: FontWeight.normal, fontSize: 15.0,  fontFamily: 'Candara', color: Setting.black), textAlign: TextAlign.center ),
                    const SizedBox(
                      height: 20.0,
                    ),
                    Textarea(background: Setting.gris, controller: itemsController, icon: const Icon(Icons.edit,color: Setting.primaryColor ), label:'${AppLocalizations.of(context)!.txt_bloc22} *',),
                    const SizedBox(
                      height: 10.0,
                    ),
